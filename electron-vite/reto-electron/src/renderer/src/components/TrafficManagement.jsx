        ...
        <Router>
            ...
            <div className="sidebar">
                    ...
                    <ul>
                        ...
                        <li><NavLink to="/camaras/modificar" className={({ isActive }) => isActive ? "active" : "inactive"}>Cámaras</NavLink></li>
                        <li><NavLink to="/flujo-de-trafico/modificar" className={({ isActive }) => isActive ? "active" : "inactive"}>Flujo de Tráfico</NavLink></li>
                    </ul>
                </div>
